EXAMPLES = [
    ...
    },
    {
        ...
        "expectedProjectedString": '<div id="n0"><b id="n1">Hello</b> world</div>',
    },
    {
        ...
        "expectedProjectedString": '<div id="n0"><b id="n1">Welcome</b> to Wikipedia,</div>',
    },
    {
        ...
        "expectedProjectedString": '<div id="n0"><br>articles<b id="n1"> in Spanish.</b></div>',
    },
    {
        "input": "<div id=n0><br><b id=n1>(hace 400 años)</b>: En Estados Unidos, se firma el <b id=n2>Pacto del Mayflower</b>, que establece un Gobierno.</div>",
        "expectedPlainString": " (hace 400 años): En Estados Unidos, se firma el Pacto del Mayflower, que establece un Gobierno.",
        "translation": "(400 years ago): In the United States, the Mayflower Pact, which establishes a government, is signed.",
        "expectedProjectedString": '<div id="n0"><br><b id="n1">(400 years ago):</b> In the United States, the Mayflower Pact, <b id="n2">which establishes a</b> government, is signed.</div>',
    },
    {
        "input": "<div id=n2> la enciclopedia de contenido libre<br>que <b id=n3>todos pueden editar</b>. </div>",
        "expectedPlainString": " la enciclopedia de contenido libre que todos pueden editar. ",
        "translation": "the free content encyclopedia that everyone can edit.",
        "expectedProjectedString": '<div id="n2"> the free content encyclopedia that<br>everyone <b id="n3">can edit.</b></div>',
    },
    {
        "input": "<div id=n0><br><b id=n1>(hace 50 años)</b>: Fallece <b id=n2>Chandrasekhara Raman</b>, físico indio (n. 1888; <b id=n3>en la imagen</b>), premio Nobel de física en 1930.</div>",
        "expectedPlainString": " (hace 50 años): Fallece Chandrasekhara Raman, físico indio (n. 1888; en la imagen), premio Nobel de física en 1930.",
        "translation": "(50 years ago): Chandrasekhara Raman, Indian physicist, dies (n 1888; in pictures), Nobel laureate in 1930.",
        "expectedProjectedString": '<div id="n0"><br><b id="n1">(50 years ago):</b> Chandrasekhara Raman, <b id="n2">Indian physicist,</b> dies (n 1888; in pictures), <b id="n3">Nobel laureate in</b> 1930.</div>',
    },
    {
